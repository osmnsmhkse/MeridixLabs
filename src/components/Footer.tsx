          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-lg border border-surface-border bg-white text-ink-tertiary hover:text-ink hover:border-brand-blue/30 hover:bg-brand-blue-light transition-all duration-200"
              >
