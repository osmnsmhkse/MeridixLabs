...
const STATIC_PAGES: { url: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { url: "/womens-health", priority: 0.9, changeFrequency: "monthly" },
  { url: "/womens-health/learn", priority: 0.65, changeFrequency: "monthly" },
  { url: "/womens-health/learn/low-amh", priority: 0.7, changeFrequency: "monthly" },
  { url: "/womens-health/learn/perimenopause-symptoms", priority: 0.75, changeFrequency: "monthly" },
  { url: "/womens-health/learn/lean-pcos", priority: 0.7, changeFrequency: "monthly" },
  { url: "/womens-health/learn/nipt-results", priority: 0.75, changeFrequency: "monthly" },
  { url: "/womens-health/learn/endometriosis-red-flags", priority: 0.8, changeFrequency: "monthly" },
  { url: "/womens-health/learn/ferritin-without-anemia", priority: 0.75, changeFrequency: "monthly" },
