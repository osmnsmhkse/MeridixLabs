  ...
  return (
    <div id="print-zone" className="animate-fade-in space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={onReset}
          className="flex items-center gap-1.5 text-sm font-medium text-brand border border-brand/30 bg-brand/5 hover:bg-brand/10 hover:border-brand/50 transition-all px-3 py-1.5 rounded-lg"
        >
          <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
            <path fillRule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clipRule="evenodd" />
          </svg>
          ...
          {userData && userData.interpretationCount > 1 && state === "idle" ? (
            ...
            <>
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-ink tracking-tightest leading-[1.03]">
                ...
                <WordReveal text={t("welcomeReadyHighlight")} startIndex={t("welcomeReadyTitle").split(" ").length} base={0.05} wordClassName="headline-serif" />
              </h1>
